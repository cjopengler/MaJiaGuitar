...
public final class HttpUtil {
     ...
     *             异常
     */
    public static final <T> T execute(HttpUriRequest request, ResponseHandler<T> responseHandler)
        ...
        request.addHeader("User-Agent", BASIC_UA);
     ...
     *             异常
     */
    public static final <T> T executeForJsonObject(HttpUriRequest request, Class<T> classType)
